...
def get_suggested_prompts() -> str:
    return (
        ...
        "The third prompt should ask the ai to help them write in their journal. The AI therapist has the ability to save text in the users journal. "
        ...
        "The JSON must be formatted like this: [\"prompt1\", \"prompt2\", \"prompt3\", \"prompt4\"]"
    )