  ...
  return (
    <>
      ...
      <div className="journal-container flex flex-col items-center w-screen max-w-full h-screen" style={{ background: '#181824', overflow: 'hidden' }}>
        ...
        <button onClick={handleSave} disabled={saveMutation.isPending || !token} style={{ width: '100%', maxWidth: 600, margin: '0 auto 24px auto', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: 8, padding: '14px 0', fontSize: 18, fontWeight: 600, boxShadow: '0 1px 4px 0 #0002', cursor: 'pointer', position: 'sticky', bottom: 0 }}>
